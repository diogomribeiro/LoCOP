...
pdf("distance_distribution.pdf",9,8)
...
resData = fread( "/scratch/axiom/FAC/FBM/DBC/odelanea/glcoex/dribeiro/cod_identification/geuvadis/all_chr/final_fdr0.01/final_dataset/CODer_raw_results.bed", stringsAsFactors = FALSE, header = TRUE, sep="\t")
null = fread( "/scratch/axiom/FAC/FBM/DBC/odelanea/glcoex/dribeiro/cod_identification/geuvadis/all_chr/final_fdr0.01/final_dataset/CODer_distance_controlled_null.bed", stringsAsFactors = FALSE, header = TRUE, sep="\t")

# resData = fread( "/scratch/axiom/FAC/FBM/DBC/odelanea/glcoex/dribeiro/cod_identification/GTEx/all_tissues/Lung/CODer_raw_results.bed", stringsAsFactors = FALSE, header = TRUE, sep="\t")
# null = fread( "/scratch/axiom/FAC/FBM/DBC/odelanea/glcoex/dribeiro/cod_identification/GTEx/all_tissues/Lung/final_dataset/CODer_distance_controlled_null.bed", stringsAsFactors = FALSE, header = TRUE, sep="\t")
